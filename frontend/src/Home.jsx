        ...
        <div style={{ backgroundColor: 'white', borderRadius: '12px', overflow: 'hidden', textAlign: 'center', boxShadow: '0 4px 15px rgba(0,0,0,0.05)', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ padding: '30px', flex: '1', display: 'flex', flexDirection: 'column' }}>
            ...
            <p style={{ color: '#666', lineHeight: '1.6', margin: 0 }}>
              We are thrilled to welcome you to our home. Kim, Mike & Dianne. We love sharing our slice of heaven in the canyon and providing you with genuine hospitality, great food, and the best local tips.
            </p>
          </div>
        </div>
